...
<template>
   <section v-if="$contact.data" id="contact" class="snap-start scroll-mt-0 relative w-screen h-full  lg:min-h-screen mb-10 lg:mb-20 flex justify-center items-center  box-border">
